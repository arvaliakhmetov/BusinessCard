...
enum class FaceDirection(val eulerX:Float,val eulerY: Float){
    ...
    FACE_EXTRA2(0f,0F),
    FACE_EXTRA16(0f,0F),
    FACE_RIGHT_TOP_1(20.89366f,-28.165407f),
    FACE_EXTRA8ds(0f,0F),
    FACE_EXTRA1734sg(0f,0F),
    FACE_EXTRA3(0f,0F),
    FACE_EXTRA17(0f,0F),
    FACE_LEFT_TOP_2(20.508915f,28.851017f),
    FACE_EXTRA8df(0f,0F),
    FACE_EXTRA1734asd(0f,0F),
    FACE_EXTRA4(0f,0F),
    FACE_EXTRA167(0f,0F),
    FACE_RIGHT_TOP_2(28.18026f,-18.73303f),
    FACE_EXTRA8sd(0f,0F),
    ...
    FACE_RIGHT_BOTTOM_1(-12.0886707f,-25.108055f),
    FACE_EXTRA8(0f,0F),
